...
import VideoB from '../assets/Video/VideoBg.mp4';
...
const Home = () => {
  ...
  return (
    <div className="relative w-full h-screen">
      ...
      />
      <div className="hidden md:block absolute z-20 top-[350px] left-[200px] transform -translate-y-1/2 p-8 h-[400px] bg-white bg-opacity-90 shadow-lg w-[410px]">
