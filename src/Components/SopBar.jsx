...
const SopBar = () => {
  return (
    <div className="bg-white py-[30px] border-b ">
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-center">
        ...
        <div className="flex items-center md:mb-0 justify-center md:justify-end mt-8 md:mt-0 ">
            <div>
              <div className="flex flex-row items-center md:ml-[160px] ml-[120px] ">
